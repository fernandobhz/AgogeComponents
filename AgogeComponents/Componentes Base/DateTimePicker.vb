...
#Region "Member variables"
    ...
    Private _customFormat As String = "dd/MM/yyyy"
...
#Region "Open Today"
    Private TodayFlag As Boolean = False

    Private Shadows Sub Enter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Enter
        If (TodayFlag = False) And (Me.Value = Nothing) Then
            TodayFlag = True
            Me.Value = Today
            Me.Value = Nothing
        End If
...
#Region "Constructor"
    ...
    Public Sub New()
        ...
        MyBase.CustomFormat = "dd/MM/yyyy"
        NullValue = " "
